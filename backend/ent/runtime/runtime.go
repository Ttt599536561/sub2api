...
func init() {
	...
	// groupDescAllowSubscriptionDayReset is the schema descriptor for allow_subscription_day_reset field.
	groupDescAllowSubscriptionDayReset := groupFields[12].Descriptor()
	// group.DefaultAllowSubscriptionDayReset holds the default value on creation for the allow_subscription_day_reset field.
	group.DefaultAllowSubscriptionDayReset = groupDescAllowSubscriptionDayReset.Default.(bool)
	...
	subscriptiondailyreseteventFields := schema.SubscriptionDailyResetEvent{}.Fields()
	_ = subscriptiondailyreseteventFields
	// subscriptiondailyreseteventDescSource is the schema descriptor for source field.
	subscriptiondailyreseteventDescSource := subscriptiondailyreseteventFields[3].Descriptor()
	// subscriptiondailyresetevent.SourceValidator is a validator for the "source" field. It is called by the builders before save.
	subscriptiondailyresetevent.SourceValidator = subscriptiondailyreseteventDescSource.Validators[0].(func(string) error)
	// subscriptiondailyreseteventDescOperationID is the schema descriptor for operation_id field.
	subscriptiondailyreseteventDescOperationID := subscriptiondailyreseteventFields[4].Descriptor()
	// subscriptiondailyresetevent.OperationIDValidator is a validator for the "operation_id" field. It is called by the builders before save.
	subscriptiondailyresetevent.OperationIDValidator = subscriptiondailyreseteventDescOperationID.Validators[0].(func(string) error)
	// subscriptiondailyreseteventDescRequestFingerprint is the schema descriptor for request_fingerprint field.
	subscriptiondailyreseteventDescRequestFingerprint := subscriptiondailyreseteventFields[5].Descriptor()
	// subscriptiondailyresetevent.RequestFingerprintValidator is a validator for the "request_fingerprint" field. It is called by the builders before save.
	subscriptiondailyresetevent.RequestFingerprintValidator = subscriptiondailyreseteventDescRequestFingerprint.Validators[0].(func(string) error)
	// subscriptiondailyreseteventDescBeforeVersion is the schema descriptor for before_version field.
	subscriptiondailyreseteventDescBeforeVersion := subscriptiondailyreseteventFields[6].Descriptor()
	// subscriptiondailyresetevent.BeforeVersionValidator is a validator for the "before_version" field. It is called by the builders before save.
	subscriptiondailyresetevent.BeforeVersionValidator = subscriptiondailyreseteventDescBeforeVersion.Validators[0].(func(int64) error)
	// subscriptiondailyreseteventDescAfterVersion is the schema descriptor for after_version field.
	subscriptiondailyreseteventDescAfterVersion := subscriptiondailyreseteventFields[7].Descriptor()
	// subscriptiondailyresetevent.AfterVersionValidator is a validator for the "after_version" field. It is called by the builders before save.
	subscriptiondailyresetevent.AfterVersionValidator = subscriptiondailyreseteventDescAfterVersion.Validators[0].(func(int64) error)
	// subscriptiondailyreseteventDescTimezone is the schema descriptor for timezone field.
	subscriptiondailyreseteventDescTimezone := subscriptiondailyreseteventFields[8].Descriptor()
	// subscriptiondailyresetevent.TimezoneValidator is a validator for the "timezone" field. It is called by the builders before save.
	subscriptiondailyresetevent.TimezoneValidator = subscriptiondailyreseteventDescTimezone.Validators[0].(func(string) error)
	// subscriptiondailyreseteventDescDaySequence is the schema descriptor for day_sequence field.
	subscriptiondailyreseteventDescDaySequence := subscriptiondailyreseteventFields[10].Descriptor()
	// subscriptiondailyresetevent.DaySequenceValidator is a validator for the "day_sequence" field. It is called by the builders before save.
	subscriptiondailyresetevent.DaySequenceValidator = func() func(int) error {
		validators := subscriptiondailyreseteventDescDaySequence.Validators
		fns := [...]func(int) error{
			validators[0].(func(int) error),
			validators[1].(func(int) error),
		}
		return func(day_sequence int) error {
			for _, fn := range fns {
				if err := fn(day_sequence); err != nil {
					return err
				}
			}
			return nil
	...
	// subscriptiondailyreseteventDescAfterDailyUsageUsd is the schema descriptor for after_daily_usage_usd field.
	subscriptiondailyreseteventDescAfterDailyUsageUsd := subscriptiondailyreseteventFields[12].Descriptor()
	// subscriptiondailyresetevent.DefaultAfterDailyUsageUsd holds the default value on creation for the after_daily_usage_usd field.
	subscriptiondailyresetevent.DefaultAfterDailyUsageUsd = subscriptiondailyreseteventDescAfterDailyUsageUsd.Default.(float64)
	// subscriptiondailyreseteventDescDeductedSeconds is the schema descriptor for deducted_seconds field.
	subscriptiondailyreseteventDescDeductedSeconds := subscriptiondailyreseteventFields[16].Descriptor()
	// subscriptiondailyresetevent.DefaultDeductedSeconds holds the default value on creation for the deducted_seconds field.
	subscriptiondailyresetevent.DefaultDeductedSeconds = subscriptiondailyreseteventDescDeductedSeconds.Default.(int)
	...
	// usersubscriptionDescAutoDailyResetEnabled is the schema descriptor for auto_daily_reset_enabled field.
	usersubscriptionDescAutoDailyResetEnabled := usersubscriptionFields[5].Descriptor()
	// usersubscription.DefaultAutoDailyResetEnabled holds the default value on creation for the auto_daily_reset_enabled field.
	usersubscription.DefaultAutoDailyResetEnabled = usersubscriptionDescAutoDailyResetEnabled.Default.(bool)
	// usersubscriptionDescDailyResetVersion is the schema descriptor for daily_reset_version field.
	usersubscriptionDescDailyResetVersion := usersubscriptionFields[6].Descriptor()
	// usersubscription.DefaultDailyResetVersion holds the default value on creation for the daily_reset_version field.
	usersubscription.DefaultDailyResetVersion = usersubscriptionDescDailyResetVersion.Default.(int64)
	// usersubscription.DailyResetVersionValidator is a validator for the "daily_reset_version" field. It is called by the builders before save.
	usersubscription.DailyResetVersionValidator = usersubscriptionDescDailyResetVersion.Validators[0].(func(int64) error)
	// usersubscriptionDescPreserveCalendarDailyReset is the schema descriptor for preserve_calendar_daily_reset field.
	usersubscriptionDescPreserveCalendarDailyReset := usersubscriptionFields[7].Descriptor()
	// usersubscription.DefaultPreserveCalendarDailyReset holds the default value on creation for the preserve_calendar_daily_reset field.
	usersubscription.DefaultPreserveCalendarDailyReset = usersubscriptionDescPreserveCalendarDailyReset.Default.(bool)
